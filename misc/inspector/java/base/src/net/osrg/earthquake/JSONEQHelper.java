...
public class JSONEQHelper extends Helper
{
	...
	super (rule);
	throw new UnsupportedOperationException("JSONEQHelper has been eliminated. Use PBEQHelper instead. pynmz will be supported as a plugin of namazu. -- July 8, 2015.");
    }
}
