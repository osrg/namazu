...
class SyslogInspectorBase(object):
    def __init__(self, udp_port=10514, orchestrator_rest_url='http://localhost:10080/api/v2',
        ...
        class SyslogUDPHandler(SocketServer.BaseRequestHandler):
            def handle(self):
                ...
                that.on_syslog_recv(self.client_address[0], self.client_address[1], data)

        self.syslog_server = SocketServer.UDPServer(('0.0.0.0', udp_port), SyslogUDPHandler)
