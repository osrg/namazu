...
$MATERIALS_DIR/bin/zkServer.sh --config $WORKING_DIR/quorumconf/1 start
$MATERIALS_DIR/bin/zkServer.sh --config $WORKING_DIR/quorumconf/2 start
RECONFIG_ADD_SERVER 2 10 5
$MATERIALS_DIR/bin/zkServer.sh --config $WORKING_DIR/quorumconf/3 start
